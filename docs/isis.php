...
class IsisXml {
    ...
    public function open()
    {
        if ( $this->path != "" && file_exists($this->path))
        {
            ...
            throw new ErrorException('No se ha definido ningÂ£n archivo para abrir.');
    }
...
<subfield code="e">antolog¡a de cuentos</subfield>
<subfield code="f">Jos� Jim�nez Lozano</subfield>
...
<field tag="210">
<subfield code="c">Ayuntamiento de Valladolid. Fundaci¢n Municipal de Cultura</subfield>
...
<field tag="606" i1=" " i2="*">
<subfield code="a">CUENTO ESPA¥OL</subfield>
</field>
<field tag="607" i1=" " i2=" ">
</field>
<field tag="608" i1=" " i2=" ">
...
<subfield code="a">Jim�nez Lozano</subfield>
<subfield code="b">Jos�</subfield>
...
<subfield code="g">r£stica</subfield>
